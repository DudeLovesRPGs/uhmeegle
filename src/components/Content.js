...
const Content = () => {
    ...
    <p>Uhmeegle <i>(uh-mee-gul)</i> is a faithful recreation of the similarly named app that was online from 2009-2023. For right now, it exists as a recreation, but new features may be added in the future. All features from the original app are intact. Chats are anonymous, but please do reveal personal information such as your name, address, or other identifying information.</p>
